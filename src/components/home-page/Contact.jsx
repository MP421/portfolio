    ...
    <>
      <section className="flex flex-col justify-center mt-20 w-[90%] mx-auto text-[#1E1E1E]" id="contact">
        ...
        <form action="" className="flex flex-col mx-auto my-6 gap-2 w-1/3">
          <label htmlFor=""></label>
          <input type="text" name="" id="" className="border-2 border-b-slate-900 p-2 pl-3 bg-slate-100 rounded-t-lg placeholder:text-slate-700" placeholder='Your name' />
          <label htmlFor=""></label>
          <input type="email" name="" id="" className="border-2 border-b-slate-900 p-2 pl-3 bg-slate-100 rounded-t-lg placeholder:text-slate-700" placeholder='Your email address' />
          <label htmlFor=""></label>
          <input type="text" name="" id="" className="border-2 border-b-slate-900 p-2 pl-3 bg-slate-100 rounded-t-lg placeholder:text-slate-700" placeholder='Your message' />
        </form>
