    ...
    <>
      <section className="flex flex-col justify-center mt-20 w-[90%] mx-auto text-[#1E1E1E]" id="contact">
        ...
        <form action="" className="flex flex-col mx-auto my-6 gap-2 w-1/3">
          <label htmlFor=""></label>
          <input type="text" name="" id="" className="border-b-2 border-b-black p-2 pl-4 bg-blue-500 rounded-md placeholder:text-slate-700" placeholder='Your name' />
          <label htmlFor=""></label>
          <input type="email" name="" id="" className="border-b-2 border-b-black p-2 pl-4 bg-blue-500 rounded-md placeholder:text-slate-700" placeholder='Your email address' />
          <label htmlFor=""></label>
          <input type="text" name="" id="" className="border-b-2 border-b-black p-2 pl-4 bg-blue-500 rounded-md placeholder:text-slate-700" placeholder='Your message' />
        </form>
