...
const Bio = () => {
  return (
    <section className="w-[45%]">
      <img src={ pracpic1 } alt="A picture of myself, frontend web developer Jonathan Owen" className="border-[4px] border-indigo-800 w-[400px] h-[350px] object-cover object-center bg-black mx-auto" />
      <h1 className="text-6xl font-black mt-8">Frontend Specialist</h1>
