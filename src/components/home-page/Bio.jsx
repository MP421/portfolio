...
const Bio = () => {
  return (
    <section className="w-[100dvw] md:w-[45%]">
      <img src={ pracpic1 } alt="A picture of myself, frontend web developer Jonathan Owen" className="border-[4px] rounded-3xl border-indigo-800 w-[300px] h-[262.5px] object-cover object-center bg-black mx-auto md:w-[400px] md:h-[350px]" />
