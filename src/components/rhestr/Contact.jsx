...
const Contact = () => {
  return (
    <section className="w-full mx-auto my-20 py-10 bg-slate-500 text-slate-50" id="contact">
      ...
      <form className="max-w-sm mx-auto">
        ...
        <button type="submit" className="bg-indigo-950 font-medium rounded-lg text-sm px-5 py-2.5 flex justify-center mx-auto">Send message</button>
      </form>
    </section>
  )
}
