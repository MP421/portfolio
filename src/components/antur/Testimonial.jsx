...
export default function Testimonial() {
  return (
    <section className="my-20 w-full h-[500px] bg-cover bg-center" style={{ backgroundImage: `url(${testimonial})` }} id="testimonials">
      <div className="h-full w-[85%] mx-auto rounded-3xl flex items-end gap-5 pb-5">
        <div className="w-1/3 h-[200px] bg-white rounded-2xl py-4 px-3">
