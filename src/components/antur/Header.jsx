...
const Header = () => {
  return (
    <header className="w-[100dvw] h-[640px] relative" id="antur-header">
      <div className="absolute w-full h-full inset-0 bg-slate-950/35"></div>
      <section className="absolute left-[50%] translate-x-[-50%] w-[85%] h-full text-slate-50 mt-4">
        ...
        <div className="absolute top-1/2 translate-y-[-50%] text-center md:text-left">
