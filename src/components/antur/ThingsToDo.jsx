...
const ThingsToDo = () => {
  return (
    <section className="my-20 w-[85%] mx-auto" id="things-to-do">
      ...
      <ul className="grid gap-6 grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 items-start">
        <Card>
          <img src={snowdon} className="h-48 w-full object-cover object-center" alt="Snowdon" />
          <div className="p-2">
            <p className="text-lg font-bold mb-1 text-center md:text-left">Snowdon</p>
        ...
        <Card>
          ...
          <div className="p-2">
            <p className="text-lg font-bold mb-1 text-center md:text-left">Caernarfon Castle</p>
            <p className="text-md text-center md:text-left">
        ...
        <Card>
          ...
          <div className="p-2">
            <p className="text-lg font-bold mb-1 text-center md:text-left">Bodnant Garden</p>
            <p className="text-md text-center md:text-left">
        ...
        <Card>
          ...
          <div className="p-2">
            <p className="text-lg font-bold mb-1 text-center md:text-left">Great Orme</p>
            <p className="text-md text-center md:text-left">
        ...
        <Card>
          ...
          <div className="p-2">
            <p className="text-lg font-bold mb-1 text-center md:text-left">Portmeirion Village</p>
            <p className="text-md text-center md:text-left">
        ...
        <Card>
          ...
          <div className="p-2">
            <p className="text-lg font-bold mb-1 text-center md:text-left">Zip World</p>
            <p className="text-md text-center md:text-left">
